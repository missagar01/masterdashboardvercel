...
import { REPAIR_API_BASE } from "../../lib/apiEndpoints";
...
const Dashboard = () => {
  ...
  const API_URL = `${REPAIR_API_BASE}/api/dashboard`;
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={[
                    ...
                    { name: 'Completed', value: totalCompletedTask || 0 },
                  ]}
                  margin={{
                    top: 20,
                    right: 20,
